...
function updateKnowledgeLubMeta(lang) {
    const title = translations[lang]?.['knowledgeLub.seo.title'];
    const desc = translations[lang]?.['knowledgeLub.seo.desc'];
    if (title) {
