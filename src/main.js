...
const translations = {
    en: {
        ...
        'apps.app6.title': 'Heat Exchanger Calculator',
        'apps.app6.version': '',
        'apps.app6.description': 'Double-pipe heat exchanger calculation tool for design and performance analysis',
    ...
    zh: {
        ...
        'apps.app6.title': '套管换热器计算器',
        'apps.app6.version': '',
        'apps.app6.description': '套管换热器设计与性能分析计算工具',
