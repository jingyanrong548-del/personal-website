export const translations = {
    en: {
        ...
        // About
        'about.title': 'About',
        'about.headline': 'Philosophy',
        'about.phil2026.blurb': 'Three decades in industrial refrigeration and heat pumps, compressed into <strong>algorithms you can audit</strong>. I stay on <strong>0→1</strong>—thermodynamics, P&ID, de-risking—and let teams own <strong>1→100</strong>. With stakeholders: ROI, TCO, and risk. This site is for <em class="highlight-quote">shipping tools, not collecting slides</em>.',
        ...
        'missionStrip.greeting': 'Electrified industrial cold & heat · Decarbonization through process coupling · Standards, refrigerants & verifiable delivery',
        ...
        'briefings.annex68.edition': 'May 2026 edition',
        'briefings.annex68.intro': 'The global database, sector integration templates, and Skills4HP cluster continue in parallel. As of early May 2026, the Project 68 news feed still highlights the Feb 2026 Copenhagen HTHP symposium outputs feeding Task 1 tracking and Task 2 collaboration, while the Task 1 tables show a “last updated” stamp around 5 May 2026—check heatpumpingtechnologies.org/project68 for the authoritative text.',
        ...
        'briefings.annex68.task1.bullet3': 'Living database: The Task 1 webpage states supplier and demonstration-case tables were refreshed around 5 May 2026 and remains open for templated submissions—consistent with the symposium message that more suppliers, higher temperatures, and larger capacities are arriving quickly.',
        ...
        'knowledge.seo.desc': 'Series: heat pump complexity, pricing per kW, AI vs human judgment in R&D, and how China, the EU, and the US steer industrial heat-pump refrigerant policy across decades (not legal advice). More chapters over time.',
        'knowledge.kicker': 'Heat pump basics · For experts and newcomers alike',
        'knowledge.seriesTitle': 'Heat pump basics',
        'knowledge.seriesLede': 'Short, independent chapters for experts and newcomers alike—from physics intuition to quoting pitfalls, AI roles in R&D, and a dated policy map of industrial heat-pump refrigerants in major markets. Useful when specialists need clear language for clients and decision-makers. Jump in via the list below or read in order.',
        'knowledge.toc.title': 'Chapters',
        'knowledge.toc.item1.kicker': 'Part 1 · Cognition',
        'knowledge.toc.item1.linkTitle': 'Why boilers feel simple, but heat pumps look “complicated”',
        'knowledge.toc.item2.kicker': 'Part 2 · Pricing & standards',
        'knowledge.toc.item2.linkTitle': 'Why “price per kilowatt” for heat pumps rarely lines up',
        'knowledge.toc.item3.kicker': 'Part 3 · AI & human roles',
        'knowledge.toc.item3.linkTitle': 'Can AI fully replace humans in refrigeration & heat-pump R&D?',
        'knowledge.toc.item4.kicker': 'Part 4 · Refrigerants & policy',
        'knowledge.toc.item4.linkTitle': 'Industrial heat-pump refrigerants: how China, the EU, and the US pull policy in different directions',
        ...
        'knowledge.article2.units.b3': '<strong>Money per “匹” (HP):</strong> often a compressor sizing habit or legacy cooling shorthand; it is not a stable, auditable heating kW across brands. Mixed use is where apples become oranges.',
    ...
    zh: {
        ...
        'about.title': '关于',
        'about.headline': '工程哲学',
        'about.phil2026.blurb': '三十年工业制冷与热泵现场，沉淀为<strong>可审计的算法与工具</strong>。工作聚焦 <strong>0→1</strong>（热力学、P&ID、排雷），<strong>1→100</strong> 交由团队；与业务讲清 ROI、TCO 与风险。本站只做一件事：<em class="highlight-quote">交付工具，压低现场不确定性</em>。',
        ...
        'missionStrip.greeting': '电气化工业冷热 · 脱碳与工艺耦合 · 标准、工质与可验证交付',
        ...
        'briefings.future.title': '即将举行的展会与活动',
        ...
        'briefings.annex68.edition': '2026年5月版',
        'briefings.annex68.intro': '全球技术数据库、行业集成模版与 Skills4HP 培训集群三条任务线持续推进；截至 2026 年 5 月上旬官网新闻栏最新活动仍以 2 月哥本哈根 HTHP 研讨会公开稿为主，Task 1 页面表册时间戳显示 5 月 5 日前后仍有更新——完整表述请以 IEA HPT Project 68 官网为准。',
        ...
        'briefings.annex68.task1.bullet3': '滚动更新：据 Task 1 专用页面，供应商技术与示范案例表于 2026 年 5 月 5 日前后刷新，并继续按模板征集新的技术/案例提报——与哥本哈根会议「更多供方、更高温度、更大容量」的公开结论相互印证。',
        ...
        'knowledge.seo.desc': '系列短文：热泵为何形态多；元/kW、kcal/h、匹与工况对齐；研发中 AI 与人的分工；以及中国、欧盟、美国在工业热泵制冷剂政策上的不同节奏（非法律意见）。后续将持续增补篇章。',
        'knowledge.kicker': '热泵小知识 · 面向所有读者',
        'knowledge.seriesTitle': '热泵小知识',
        'knowledge.seriesLede': '面向所有读者的独立短章，从物理直觉到商务口径、「AI 能做什么、不能替什么」，再到中/欧/美工业热泵制冷剂政策地图（带年代节点，非法律意见）；也便于专业读者对外说明、帮助非专业合作方建立共同语言。可从下方目录任选一篇，也可按顺序阅读。',
        'knowledge.toc.title': '目录',
        'knowledge.toc.item1.kicker': '第 1 讲 · 认知',
        'knowledge.toc.item1.linkTitle': '为什么锅炉“很简单”，而热泵看起来“很复杂”？',
        'knowledge.toc.item2.kicker': '第 2 讲 · 商务与标准',
        'knowledge.toc.item2.linkTitle': '「热泵单价」为什么总对不齐？——先对齐工况，再谈元/kW',
        'knowledge.toc.item3.kicker': '第 3 讲 · AI 与人的分工',
        'knowledge.toc.item3.linkTitle': 'AI 能完全替代人做制冷/热泵研发吗？',
        'knowledge.toc.item4.kicker': '第 4 讲 · 工质与政策',
        'knowledge.toc.item4.linkTitle': '工业热泵制冷剂：中、欧、美政策各往哪边走？',
        ...
        'knowledge.article2.units.b3': '<strong>元 / 匹：</strong>常被混用作压缩机习惯档或历史冷量口径，<strong>不等同于</strong>可审计、可跨品牌对齐的制热 kW；混用分母时最容易「数字对、结论错」。',
        ...
        'knowledge.article3.lede': '不能——至少在「真正要紧」的环节上不能。AI 可以加速查资料、对齐表格与起草说明，但制冷与热泵研发仍依赖人对工况假设、安全边界、涉密工艺数据以及法律责任链的判定；这也是第 2 讲快问快答里「AI 不能替代工程师签字假设」的延伸说明。',
        ...
        'knowledge.article4.lede': '舒适空调与工业热泵会共用许多工质「名字」，但工业现场往往意味着更高温升、更大充注与更严的现场规范。政策工具里常见 HFC 削减、配额式氟化气体管理、化学品/PFAS 监管，以及各国标准与产品准入——<strong>节奏与抓手并不对齐</strong>。本篇是帮助建立地图的科普，不构成法律意见：请以项目所在地及出货目的地主管部门的<strong>现行有效文本</strong>为准做合规核对。',
