export const translations = {
    en: {
        ...
        // Knowledge page
        'knowledge.seo.title': 'Heat pump basics — Short reads for non-experts',
        'knowledge.seo.desc': 'Series: why heat pumps branch into many forms; how to read price per kW, kcal/h, and HP; aligning rating conditions before comparing quotes. More chapters over time.',
        'knowledge.kicker': 'Heat pump basics · For non-experts',
        'knowledge.seriesTitle': 'Heat pump basics',
        'knowledge.seriesLede': 'Short, independent chapters for non-experts—from physics intuition to quoting pitfalls. Jump in via the list below or read in order.',
        ...
        'knowledge.article2.aiNote.title': 'Editor’s note: “AI industrial heat pump expert” as a writing partner',
        'knowledge.article2.aiNote.text': 'For RFQs and internal memos, AI is useful to normalize rating tables, flag mismatched denominators (kW thermal vs kW electric vs “HP”), and draft polite clarification language. Selection, safety limits, compliance, and commissioning acceptance remain engineering responsibilities—not a chatbot warranty.',
    ...
    zh: {
        ...
        'knowledge.seo.desc': '系列短文：热泵为何形态多；元/kW、kcal/h、匹等报价如何先对齐工况再比价。后续将持续增补篇章。',
        'knowledge.kicker': '热泵小知识 · 面向非专业读者',
        'knowledge.seriesTitle': '热泵小知识',
        'knowledge.seriesLede': '面向非专业读者的独立短章，从物理直觉到商务口径。可从下方目录任选一篇，也可按顺序阅读。',
        ...
        'knowledge.article2.aiNote.title': '编者按：把「AI 工业热泵专家」放在什么位置',
        'knowledge.article2.aiNote.text': '对标书、邮件与内部纪要，AI 适合用来<strong>整理工况表、检查分母是否一致、起草委婉澄清话术</strong>。但选型边界、安全与法规符合性、验收责任，仍应以工程师与标准为准——AI 是缕清说辞的助手，不是设备担保方。',
        ...
        'knowledge.article2.faq.q2.a': '文字相近不等于测试与边界相同：容差、辅机是否计入、除霜折算、水力假设、供货范围（控制/安装）都会影响总价。应把价格看作<strong>打包方案</strong>，而不是 brochure 上一行数除以单价。',
