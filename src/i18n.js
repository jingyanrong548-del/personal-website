export const translations = {
    ...
    zh: {
        ...
        'knowledge.article3.lede': '不能——至少在「真正要紧」的环节上不能。AI 可以加速查资料、对齐表格与起草说明，但制冷与热泵研发仍依赖人对工况假设、安全边界、涉密工艺数据以及法律责任链的判定；这也是第 3 讲快问快答里「AI 不能替代工程师签字假设」的延伸说明。',
