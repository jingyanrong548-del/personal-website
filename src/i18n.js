export const translations = {
    ...
    zh: {
        ...
        'knowledge.toc.item1.linkTitle': '极寒重器：为什么我们坚决选择 CO₂ (R744) 复叠热泵？',
        ...
        'knowledge.co2.title': '极寒重器：为什么我们坚决选择 CO₂ (R744) 复叠热泵？',
        'knowledge.co2.subtitle': '—— 常规氟系统复叠与 CO₂ 复叠路线深度对决',
        'knowledge.co2.p1': '在 −20℃ 以北的广袤冰雪市场，热泵技术面临着物理极限的考验。常规的氟系统复叠（如 R410A/R32 + R134a）试图强攻极寒，结果往往是能效崩盘、设备频频宕机。',
        'knowledge.co2.p2': '作为工业热泵研发团队，我们坚决采用 <strong>CO₂ (R744) + R515B 全复叠架构</strong>。这不是盲目堆料，而是基于底层热力学与商业逻辑的必然选择。',
        'knowledge.co2.chart.figureAria': '供热需求与设备出力对比示意图',
        'knowledge.co2.chart.alt': '环境温度从 +10℃ 到 −40℃ 的示意图：橙色线为建筑与工业热负荷随降温剧增；灰色线为常规热泵（R32/R410A）在约 −20℃ 以下出力断崖式下跌；蓝色线为 150kW 级极寒机组出力缓慢下降，标注在 −40℃ 环温下仍可保持 −20℃ 时制热量约 70%；红色斜线阴影区为极寒真空地带（死亡区），表示需求上升而常规机组出力塌缩的缺口。',
        'knowledge.co2.chart.caption': '一图读懂：天越冷，热负荷越高；常规 R32/R410A 机组在约 −20℃ 以下进入“衰减断崖”，落入图中斜线阴影的极寒死亡区；150kW 级极寒（CO₂/R744 路线）机组曲线平缓，在 −40℃ 仍可保留约 −20℃ 时出力的 70%（示意与宣传口径，工程结论以项目工况表与实测为准）。',
        'knowledge.co2.compare.title': '核心对决：极寒工况的“生死线”（−40℃ 至 −25℃）',
        'knowledge.co2.th.dim': '核心维度',
        'knowledge.co2.th.fl': '常规氟系统复叠 (R410A/R32 + R134a)',
        'knowledge.co2.th.co2': '极寒专属 CO₂ 复叠 (R744 + R515B)',
        'knowledge.co2.th.insight': '专家洞察',
        'knowledge.co2.r1.dim': '极寒存活率（−40℃ 极限）',
        'knowledge.co2.r1.fl': '<span class="knowledge-co2-pill knowledge-co2-pill--bad">极易宕机</span><br>气体密度极低导致吸气困难，压比飙升至 7～8 以上，排温超 130℃，冷冻油极易碳化烧毁压缩机。',
        'knowledge.co2.r1.co2': '<span class="knowledge-co2-pill knowledge-co2-pill--good">强悍稳定</span><br>−40℃ 时 CO₂ 蒸发压力仍高达约 10 bar，系统压比仅 3～4，容积效率 &gt;75%，排气温度可控。',
        'knowledge.co2.r1.insight': '压比和排温决定了工业压缩机的命。',
        'knowledge.co2.r2.dim': '制热衰减率（−25℃～−30℃）',
        'knowledge.co2.r2.fl': '<span class="knowledge-co2-pill knowledge-co2-pill--bad">断崖下跌</span><br>制热量大打折扣，COP 逼近 1.0，最终沦为极其费电的“电辅热”。',
        'knowledge.co2.r2.co2': '<span class="knowledge-co2-pill knowledge-co2-pill--good">动力澎湃</span><br>−25℃ 环温下 COP 稳超 <strong>2.0</strong>；−30℃ 极限工况下，COP 仍保持在 1.6～1.9 之间。',
        'knowledge.co2.r2.insight': 'CO₂ 的低温高密度带来了极大的容积制热量。',
        'knowledge.co2.r3.dim': '最高出水温度',
        'knowledge.co2.r3.fl': '<span class="knowledge-co2-pill knowledge-co2-pill--bad">50℃～55℃</span><br>极寒下极难拉高水温，无法匹配北方老旧暖气片。',
        'knowledge.co2.r3.co2': '<span class="knowledge-co2-pill knowledge-co2-pill--good">80℃～90℃</span><br>低压级极限吸热，高压级恒温放热，轻松输出 80℃ 以上高温热水。',
        'knowledge.co2.r3.insight': '无需改造末端地暖，直接对接传统管网。',
        'knowledge.co2.r4.dim': '环保与合规',
        'knowledge.co2.r4.fl': '<span class="knowledge-co2-pill knowledge-co2-pill--bad">面临淘汰</span><br>高 GWP 值（R410A 高达 2088），受国际 F-gas 法案严格限制。',
        ...
        'knowledge.co2.r4.insight': '顺应国家战略，规避未来环保整改风险。',
        'knowledge.co2.biz.title': '商业算账：不看初投资，只看“回本期”',
        'knowledge.co2.biz.lede': '把常规氟系统复叠热泵强行卖到极寒地区，是典型的“小马拉大车”。客户花了做双级系统的重金，一到 −30℃ 机器依然严重衰减，初投资与运行能效“双输”。而 CO₂ 复叠的账，是这么算的：',
        'knowledge.co2.biz.li1': '<strong>工业级重装用料：</strong>150kW 级极寒机组，反推电机功率是实打实的 100P 重型装备，用料与稳定性远超轻型商用热泵。',
        'knowledge.co2.biz.li2': '<strong>运行费用腰斩：</strong>在 −30℃ 极限抗冻工况下，产出同等热量的成本比传统电锅炉、燃气锅炉<strong>节省近 50%</strong>（以项目电价/气价与运行小时核算为准）。',
        'knowledge.co2.biz.li3': '<strong>极致投资回报 (ROI)：</strong>凭借高能效带来的巨额电费节省，工业客户仅需 <strong>1.5 年至 2 年</strong>，即可抹平设备初装差价（因负荷与电价而异，需个案校核）。',
        'knowledge.co2.arch.title': '顶层架构设计：“多能耦合”才是极寒的终极堡垒',
        'knowledge.co2.arch.warningTitle': '【专家忠告：敬畏物理红线】',
        'knowledge.co2.arch.warningBody': '作为深耕行业多年的技术团队，我们从不盲目向客户吹嘘“热泵包打天下”。在内蒙、东北、新疆等极寒地带，个别极端年景气温会探底至 −50℃（甚至逼近 CO₂ 产生干冰的三相点）。在这种突破热力学物理极限的灾害性气候下，单纯依靠空气源热泵无济于事。',
        'knowledge.co2.arch.ol1': '<strong>日常极寒（−40℃ 以上）：</strong>CO₂ 热泵作为<strong>基础负荷</strong>全力输出，吃尽高能效比红利，疯狂降低运行成本。',
        'knowledge.co2.arch.ol2': '<strong>极端气象（−40℃ 以下）：</strong>系统智能监测并切换，原有燃气/电锅炉作为<strong>安全备用</strong>介入调峰。',
        'knowledge.co2.closing': '这不仅是一套省钱的装备，更是一套万无一失的能源安全系统：买的是全生命周期的财务回报与绝对不能断流的供暖底线。',
