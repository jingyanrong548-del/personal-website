export const translations = {
    en: {
        ...
        // Knowledge page
        'knowledge.seo.title': 'Heat pump basics — Why so many cycles?',
        'knowledge.seo.desc': 'A non-expert friendly explainer: why boilers feel simple, while heat pumps branch into many cycles, working fluids, and compressor types.',
    ...
    zh: {
        ...
        // Knowledge page
        'knowledge.seo.title': '热泵小知识：为什么热泵看起来这么“复杂”？',
        'knowledge.seo.desc': '面向非专业读者：解释为什么锅炉显得简单，而热泵会分化出多种循环、工质与压缩机形式。',
