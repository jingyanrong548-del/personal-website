export const translations = {
    en: {
        ...
        'hpStd.seo.desc': 'Searchable quick reference of common industrial heat-pump related standards (Chinese titles and notes), with category filter and latest/upcoming highlights. Not legal advice.',
        'hpStd.kicker': 'Industrial heat pumps · Standards quick reference',
        'hpStd.pageTitle': 'Industrial heat pump standards',
        'hpStd.lede': 'Search and filter GB / JB / NB and related norms for industrial heat-pump projects. Table entries remain in Chinese as in the working compilation.',
        'hpStd.searchPlaceholder': 'Search standard number, title, or keywords…',
        'hpStd.filter.allCategories': 'All categories',
        'hpStd.filter.latestOnly': 'Latest / upcoming only',
        'hpStd.table.category': 'Category',
        'hpStd.table.stdNumber': 'Standard No.',
        'hpStd.table.stdName': 'Title',
        'hpStd.table.coreContent': 'Scope & key notes',
    ...
    zh: {
        ...
        'hpStd.lede': '按标准号、名称与要点检索、筛选 GB/JB/NB 等与工业热泵相关的常用标准；表格正文保持中文整理口径，便于现场对照。',
        'hpStd.searchPlaceholder': '搜索标准号、名称、核心内容…',
        'hpStd.filter.allCategories': '所有分类',
        'hpStd.filter.latestOnly': '仅显示最新/即将实施',
        'hpStd.table.category': '标准分类',
        'hpStd.table.stdNumber': '标准号',
        'hpStd.table.stdName': '标准名称',
        'hpStd.table.coreContent': '核心内容与适用范围',
