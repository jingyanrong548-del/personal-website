export const translations = {
    en: {
        ...
        'usefulLinks.seo.desc': 'Curated external links to Dorin Selection, Bitzer WEBsoftware, and Bock VAP (transcritical CO₂). Third-party sites; verify against catalogs and tests.',
    ...
    zh: {
        ...
        'usefulLinks.seo.desc': '本站整理的 Dorin、Bitzer、Bock 等官方线上选型与性能数据入口（外链）；请以样本册、型式试验与现场数据交叉验证。',
