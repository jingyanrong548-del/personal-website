...
function updateKnowledgeHxMeta(lang) {
    const title = translations[lang]?.['knowledgeHx.seo.title'];
    const desc = translations[lang]?.['knowledgeHx.seo.desc'];
    if (title) {
