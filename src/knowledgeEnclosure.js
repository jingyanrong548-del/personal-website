...
function updateKnowledgeEnclMeta(lang) {
    const title = translations[lang]?.['knowledgeEncl.seo.title'];
    const desc = translations[lang]?.['knowledgeEncl.seo.desc'];
    if (title) {
