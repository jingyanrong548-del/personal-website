...
function updateKnowledgeCompMeta(lang) {
    const title = translations[lang]?.['knowledgeComp.seo.title'];
    const desc = translations[lang]?.['knowledgeComp.seo.desc'];
    if (title) {
