...
function updateKnowledgeElecMeta(lang) {
    const title = translations[lang]?.['knowledgeElec.seo.title'];
    const desc = translations[lang]?.['knowledgeElec.seo.desc'];
    if (title) {
