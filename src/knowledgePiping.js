...
function updateKnowledgePipeMeta(lang) {
    const title = translations[lang]?.['knowledgePipe.seo.title'];
    const desc = translations[lang]?.['knowledgePipe.seo.desc'];
    if (title) {
